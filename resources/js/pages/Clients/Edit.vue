                ...
                <div class="space-y-1">
                    ...
                    >
                        <Link :href="show.url(client.id)">
                            <ArrowLeft class="mr-1.5 h-4 w-4" /> Back to Client
                            Profile
                        </Link>
                    </Button>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            >
                                Update record details, lead status, and
                                requested service requirements for
                                <span
                    ...
                    >
                        ...
                        >
                            ...
                            <CardDescription class="text-xs text-slate-500">
                                Modify contact numbers, company details, and
