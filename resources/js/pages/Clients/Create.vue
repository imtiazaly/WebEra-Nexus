        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            >
                <div>
                    ...
                    >
                        <Link :href="index.url()">
                            <ArrowLeft class="mr-1.5 h-4 w-4" /> Back to Clients
                            List
                        </Link>
                    </Button>
                    ...
                    >
                        Fill in client contact details, company profile, and
                    ...
                    >
                        ...
                        >
                            ...
                            <CardDescription class="text-xs text-slate-500">
                                Enter personal and company background details
                                for record keeping.
                            </CardDescription>
                        </CardHeader>
                                ...
                                <div class="space-y-1.5 md:col-span-2">
                                    ...
                                    >
                                        ...
                                        <option value="converted">
                                            🟢 Converted Client (Active Project)
                                        </option>
                                        <option value="lost">
                                            🔴 Lost (Closed / Inactive)
                                        </option>
                                    </select>
                        ...
                        <CardContent class="p-6">
                            ...
                            <div v-else class="space-y-4">
                                <div
                                    ...
                                    :class="[
                                        ...
                                        isServiceSelected(service.id)
                                            ? 'border-indigo-500 bg-indigo-50/30 shadow-xs dark:border-indigo-600 dark:bg-indigo-950/20'
                                ...
                                >
                                    ...
                                    <div
                                        v-if="isServiceSelected(service.id)"
                                        class="space-y-3 border-t border-indigo-200/60 pt-3 dark:border-indigo-900/40"
                                    >
                                        <div class="space-y-1.5">
                                            <Label
                                                class="flex items-center gap-1 text-[11px] font-semibold text-slate-700 dark:text-slate-300"
                                            >
                                                <FileText
                                        ...
                                        <div class="space-y-1.5">
                                            ...
                                            <div class="relative">
                                                <span
                                                    class="absolute top-1/2 left-3 -translate-y-1/2 text-xs font-bold text-slate-400"
                                                    >$</span
                                                >
                                                <Input
                                                    v-model="
                                                    ...
                                                    class="h-9 border-slate-200 pl-7 text-xs focus:border-indigo-500 dark:border-slate-800 dark:bg-slate-950"
                                                />
                                            </div>
                                        </div>
                                    </div>
