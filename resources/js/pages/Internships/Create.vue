...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Create Batch Studio', href: '#' },
        ],
    },
});
...
<template>
    <Head title="Create Internship Batch Studio" />
            ...
            <div class="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="space-y-2">
                    <div class="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3.5 py-1 text-xs font-semibold tracking-wide text-indigo-700 backdrop-blur-md dark:border-indigo-400/30 dark:bg-indigo-500/10 dark:text-indigo-300">
                        <Wand2 class="h-3.5 w-3.5 text-indigo-600 dark:text-indigo-400" />
                        <span>Academy Batch Builder Studio</span>
                    </div>
                    ...
                    <p class="max-w-xl text-xs font-medium text-slate-600 sm:text-sm dark:text-slate-300">
                        Configure new training tracks, batch codes, start/end date telemetry, and live status allocations.
                    </p>
                </div>
                    ...
                    <CardContent class="p-6 sm:p-8">
                        <form @submit.prevent="submit" class="space-y-8">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        type="text"
                                        required
                                        placeholder="e.g. Front-End Web Engineering Bootcamp"
                            ...
                            <div class="flex items-center justify-end gap-3 border-t border-slate-200/80 pt-6 dark:border-slate-800">
                                ...
                                >
                                    <Plus class="mr-2 h-4 w-4" /> Save & Launch Batch
                                </Button>
                            </div>
                        </form>
                    </CardContent>
                    ...
                    <div class="relative z-10 space-y-5">
                        ...
                        <div class="space-y-2 rounded-2xl border border-slate-100 bg-slate-50/80 p-3.5 dark:border-slate-800/80 dark:bg-slate-800/40">
                            ...
                            <div class="h-2 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700">
                                <div class="h-full rounded-full bg-gradient-to-r from-indigo-500 via-cyan-500 to-emerald-500 w-1/2"></div>
                            </div>
                        ...
                        <div class="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-xs font-bold text-slate-700 dark:text-slate-300">0 Trainees Enrolled</span>
                            </div>
                            <span class="text-[11px] font-bold text-indigo-600 dark:text-indigo-400">Ready to Launch →</span>
                        </div>
                    </div>
                </div>
            </div>
